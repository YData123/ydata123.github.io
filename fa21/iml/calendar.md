...
; instructions for installing this environment are available on [Yale Canvas](https://canvas.yale.edu).  The notebooks can also be run in [<img width="25" src="colab.svg">](https://colab.research.google.com) [Google Colab](https://colab.research.google.com).
